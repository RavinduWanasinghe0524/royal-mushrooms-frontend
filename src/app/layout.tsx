...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        <link rel="icon" href="/royal-mushrooms-frontend/logo.png" />
        <link rel="apple-touch-icon" href="/royal-mushrooms-frontend/logo.png" />
        <meta property="og:image" content="/royal-mushrooms-frontend/logo.png" />
